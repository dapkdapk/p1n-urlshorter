...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="javascript:window.location=scriptLocation();">
					<?= $title ?> URL
				</a>
			</div>
	...
	event: { keypress: enterKeyboardCmd}" type="url" id="inputUrl" class="form-control" placeholder="http://" required
		...
		<footer>
			<cite>Encrypted urls for one day!</cite> | <a href="https://github.com/dapkdapk/p1n-urlshorter"
